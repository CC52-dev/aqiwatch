      ...
      >
        ...
        >
          ...
          >
            ...
            >
              <span style={{ fontSize: '24px', color: '#7df9ff' }}>📊</span>
              <span style={{ fontSize: '20px', color: '#ffffff', fontWeight: '500' }}>Real-time Data</span>
            </div>
            <div
              style={{
                display: 'flex',
            ...
            >
              <span style={{ fontSize: '24px', color: '#7df9ff' }}>🤖</span>
              <span style={{ fontSize: '20px', color: '#ffffff', fontWeight: '500' }}>AI Predictions</span>
            </div>
            <div
              style={{
                display: 'flex',
            ...
            >
              <span style={{ fontSize: '24px', color: '#7df9ff' }}>❤️</span>
              <span style={{ fontSize: '20px', color: '#ffffff', fontWeight: '500' }}>Health Insights</span>
            </div>
          </div>
